    ...
    <div className="font-sans text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:[dir='rtl']:flex-row-reverse">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold mb-6">
              Hire Expert{" "}
              <span className="text-orange-600">Vue.js Developers</span>
            </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-4">
            Why Choose Vue.js for Your Application?
          </h2>
          <p className="text-gray-600 mb-12 max-w-3xl">
            Vue.js is an open-source JavaScript framework that enables
            developers to build efficient and high-performing web applications.
            It is designed for easy integration and scalability.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Vue.js allows for fast development and offers a flexible,
                modular structure to accommodate any project size.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Vue.js provides scalability, allowing the app to grow with your
                business while maintaining high performance.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Vue.js offers security features that ensure your app is safe
                from common vulnerabilities, ensuring secure and stable
                performance.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Vue.js can be used for single-page applications, or integrated
                into larger projects to enhance performance and usability.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-12 max-w-3xl">
            From planning to launch, we ensure that your Vue.js application is a
            success.{" "}
          </p>
          ...
          <div className="grid md:grid-cols-5 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Understand your Vue.js development requirements and business
                needs.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Develop clean, efficient, and scalable Vue.js applications.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Perform testing to ensure your app performs well in all
                scenarios.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Deploy your Vue.js application and ensure a smooth launch.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “DH Solution's Vue.js team was phenomenal. They delivered an
                outstanding application with great speed and performance.”
              </p>
              <h4 className="font-semibold">
                — Catherine Adams , Product Manager, ShopFlare.
              </h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “The team’s expertise in Vue.js helped us create a responsive
                and fast web app. Highly recommended!”
              </p>
              <h4 className="font-semibold">— Mark Spencer, CTO, Finverse</h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “We are extremely happy with the outcome. DH Solution provided
                top-notch Vue.js development and delivered on time.”
              </p>
              <h4 className="font-semibold">
                — Sarah Thompson,Founder, WebPros
              </h4>
            </div>
          </div>
        </div>
