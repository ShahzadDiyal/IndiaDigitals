...
export default function HireDeveloperPage() {
  return (
    <div className="font-sans text-gray-900">
      <Navbar />
      <BreadCrumb currentPage="/technologies/hire-shopify-developer" />
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:[dir='rtl']:flex-row-reverse">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold mb-6">
              Hire Expert{" "}
              <span className="text-orange-600">Shopify Experts</span>
            </h1>
            <p className="text-lg text-gray-600 mb-8">
              Top 1% engineers to build stunning, high-converting Shopify stores
              fast.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-4">
            Why Choose Shopify for Your Store?
          </h2>
          <p className="text-gray-600 mb-12 max-w-3xl">
            Shopify is the go-to platform for launching, scaling, and managing
            modern ecommerce brands. It's secure, flexible, and built for
            growth.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Launch your store in days with a platform that's built for speed
                and ease.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                From 10 to 10,000 products, Shopify scales with your business
                without compromise.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-xl mb-3">Secure & Reliable</h3>
              <p className="text-gray-600">
                Shopify offers best-in-class security and 24/7 uptime for
                uninterrupted sales.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Tailor your store with custom themes, integrations, and advanced
                features.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-5 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Understand your goals, Shopify needs & business model.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Create a Shopify strategy aligned with your brand.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Design and develop a high-converting Shopify store.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                QA to ensure a seamless shopping experience.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Go live and monitor for ongoing success.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “Their Shopify experts helped us double our conversions within
                weeks!”
              </p>
              <h4 className="font-semibold">
                — Maya Thompson, Ecom Manager, GlowBoutique .
              </h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “Exceptional work! Our new Shopify store looks stunning and
                works flawlessly.”
              </p>
              <h4 className="font-semibold">
                — Lucas Grant, Founder, CraftNest
              </h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “From design to development, they nailed every part of the
                process.”
              </p>
              <h4 className="font-semibold">— Ravi Patel, CEO, UrbanFit</h4>
            </div>
          </div>
        </div>
      </section>
