...
const page = () => {
  ...
  const t = useTranslations("technologies-page")
      ...
      <section className=" px-7 md:px-36 pb-16">
        ...
        <div className="my-6">
          <span className="font-medium text-4xl sm:text-5xl xl:text-6xl ">
            <b className=" text-gray-900/90 my-4"> {t("whatsYourStack")}&nbsp;</b>
            <br className="xl:block hidden" />
            <b className=" text-orange-600/95 my-4"> {t("weCoverTopOfThem")}</b>
          </span>
        </div>
      </section>

      <section className=" bg-gray-200/70 px-7 md:pl-36 md:pr-10 pt-10 md:pt-20 pb-32">
        <h2 className="text-3xl font-medium">{t("quickFilter")}</h2>
        <select
