    ...
    <div className="font-sans text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:[dir='rtl']:flex-row-reverse">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold mb-6">
              Hire Expert{" "}
              <span className="text-orange-600">Node.js Developers</span>
            </h1>
            <p className="text-lg text-gray-600 mb-8">
              Top 1% engineers to build fast, scalable, and real-time backend
              systems.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-12 max-w-3xl">
            Node.js is a powerful JavaScript runtime ideal for high-performance
            web apps, APIs, and real-time systems. It handles concurrent
            connections efficiently with non-blocking I/O.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-xl mb-3">High Speed</h3>
              <p className="text-gray-600">
                Powered by Google’s V8 engine, Node.js ensures ultra-fast
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Event-driven and non-blocking architecture enables scaling apps
                effortlessly.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-xl mb-3">Secure APIs</h3>
              <p className="text-gray-600">
                Robust authentication, middleware, and request validation keep
                your data safe.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-xl mb-3">Real-time Ready</h3>
              <p className="text-gray-600">
                Build chat apps, streaming services, and collaborative tools
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-12 max-w-3xl">
            Understand your app goals, backend needs & scaling challenges.
          </p>
          ...
          <div className="grid md:grid-cols-5 gap-8 text-start md:[dir='rtl']:text-end">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Architecture planning using Node.js best practices.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                We build APIs, microservices, and real-time apps in Node.js.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Deploy with CI/CD pipelines & provide long-term support.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “Their Node.js devs built a blazing-fast backend for our
                marketplace. Impressive work!”
              </p>
              <h4 className="font-semibold">— Liam Torres, CEO, MarketGo .</h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “Reliable Node experts. Our real-time chat app works like a
                charm!”
              </p>
              <h4 className="font-semibold">— Tina Roy , Co-Founder, Chatly</h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “Clean code, scalable logic, and amazing communication. Highly
                recommended!”
              </p>
              <h4 className="font-semibold">
                — Aaron Kim,Tech Director, SwiftRide
              </h4>
            </div>
          </div>
        </div>
