  ...
  return (
    <div className="font-sans text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:[dir='rtl']:flex-row-reverse">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold mb-6">
              Hire Expert <span className="text-orange-600">iOS Developers</span>
            </h1>
            <p className="text-lg text-gray-600 mb-8">
             Create powerful and user-friendly iOS apps with the top 1% of engineers.
      ...
      <section className="py-20 bg-white">
        ...
        iOS frameworks like SwiftUI enable rapid app development, minimizing time to market.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                iOS apps are optimized for high performance, ensuring smooth scaling as your user base grows.{" "}
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                iOS offers robust security features, safeguarding your app and users from data breaches.
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                iOS apps integrate seamlessly with iCloud, Siri, and other native services, making them more functional.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-12 max-w-3xl">
           We follow a streamlined process to deliver flawless iOS apps.{" "}
          </p>
          ...
          <div className="grid md:grid-cols-5 gap-8 text-start md:[dir='rtl']:text-end">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
         Create a roadmap for your iOS app with emphasis on intuitive UI/UX.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
               Build an iOS app using Swift or Objective-C, focusing on performance and user experience.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Deploy the app on the Apple App Store and provide ongoing updates and support.
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              “The iOS app they created for us is flawless. It works smoothly on all devices and is loved by our users.”
              </p>
              <h4 className="font-semibold">
                — Sophia Johnson , Product Manager, TechX Inc. .
              </h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
              “The team delivered an excellent iOS app with an intuitive design. We're very happy with the results!”
              </p>
              <h4 className="font-semibold">
                — Michael Harris, Co-Founder, AppCraft
              </h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
              “We were amazed by the speed and efficiency of their iOS development. They really understood our needs.”
              </p>
              <h4 className="font-semibold">
                — Lucas White,Founder, Creative Solutions
