        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12 md:[dir='rtl']:flex-row-reverse">
          ...
          <div className="flex-1">
            <h1 className="text-5xl font-bold mb-6">
              Hire Expert{" "}
              <span className="text-orange-600">WordPress Developers</span>
            </h1>
            <p className="text-lg text-gray-600 mb-8">
              Top 1% engineers to build fast, secure, and custom WordPress
              websites.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-12 max-w-3xl">
            WordPress powers over 40% of the web for good reason — it's
            powerful, customizable, and ideal for everything from blogs to
            enterprise sites.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-xl mb-3">Quick Launch</h3>
              <p className="text-gray-600">
                With thousands of themes and plugins, your site can go live in
                record time.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-xl mb-3">Flexible CMS</h3>
              <p className="text-gray-600">
                Manage your content easily with a robust and user-friendly
                backend.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                Regular updates and strong plugin ecosystem ensure your site
                stays protected.
              </p>
            </div>
            ...
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-xl mb-3">SEO Ready</h3>
              <p className="text-gray-600">
                Built-in SEO tools and integrations help boost your search
                rankings.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-5 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Understand your vision, website goals & content structure.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Plan site architecture, features, and CMS flow.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Ensure speed, SEO, mobile responsiveness, and security.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Deploy and maintain your site with ongoing support.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-start md:[dir='rtl']:text-end">
            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “They created a fast, clean, and SEO-friendly WordPress site for
                our company.”
              </p>
              <h4 className="font-semibold">
                — Emily Chen, Marketing Director, GreenEdge .
              </h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “Great experience! Their WordPress experts delivered exactly
                what we envisioned.”
              </p>
              <h4 className="font-semibold">
                — David Martinez , Founder, PixelHaus
              </h4>
            </div>

            <div className="p-8 border rounded-2xl shadow-sm hover:shadow-md transition">
              <p className="text-gray-700 italic mb-4">
                “Smooth communication and top-notch WordPress skills. Highly
                recommend!”
              </p>
              <h4 className="font-semibold">— Nina Taylor, CEO, SmartSaaS</h4>
            </div>
          </div>
        </div>
      </section>
