      ...
      <section className="px-7 md:px-36 pb-1">
        <div className="max-w-4xl my-6">
          <h1 className="text-orange-600/95 font-bold my-2 text-4xl sm:text-5xl xl:text-6xl">
            Kobi Education Payroll System
          </h1>
          <p className="text-lg text-gray-600">
            Streamlining Payroll Management for One of the Largest Educational
            Networks
          </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Kobi Education, one of the largest educational networks, relies on
            DH Solutions for the development and maintenance of its payroll
            system. This system is designed to streamline payroll management,
            ensuring efficiency and accuracy across its extensive operations. We
            developed a custom payroll management system using the MERN stack
            (MongoDB, Express.js, React, Node.js). The system handles various
            payroll functions with ease, including salary calculation, bonus
            management, and more.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Kobi Education required a scalable, secure, and efficient payroll
            system that could manage payroll processing for thousands of
            employees across multiple campuses and regions. The solution had to
            integrate seamlessly with their existing HR systems and be highly
            customizable to meet varying payroll structures.
          </p>
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              DH Solution handled the full-stack development of the payroll
              system, including both front-end and back-end development. We
              worked closely with Kobi Education's HR team to ensure the system
              met all their requirements, including compliance with local tax
              laws and handling various compensation structures. Our team also
              managed the deployment and ongoing maintenance of the system.
            </p>
          </div>
        </div>
      </section>
  ...
  <div className="max-w-6xl mx-auto px-6 text-center">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 md:gap-10 justify-items-center">
      {tools.map((tool, index) => (
        <div
          key={index}
          className={`group bg-gradient-to-b ${tool.color} hover:from-white hover:to-gray-50 border border-gray-200 hover:border-gray-300 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 w-full max-w-[180px] sm:max-w-[200px] min-h-[180px] flex flex-col items-center justify-center p-6`}
        >
