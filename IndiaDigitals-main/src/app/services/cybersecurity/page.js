...
const imageUrl = "https://dhsol.net/_next/static/media/5.9fe568e9.svg";
const page = () => {
        ...
        <div className="my-6 flex w-full ">
          <div className="flex flex-col gap-4 lg:gap-0 justify-between py-10 w-full lg:w-[670px] xl:w-[820px]">
            <h1 className=" text-gray-900/90 font-medium  text-4xl sm:text-5xl xl:text-6xl">
              {/* {t("subheading")}&nbsp; */}
              Expert Comprehensive Cybersecurity Solutions
            </h1>
            <p className=" text-gray-900/70 my-4 text-xl ">
              {/* {t("description")} */}
              At DH Solutions, we specialize in delivering comprehensive
              cybersecurity solutions tailored to protect your organization from
              evolving digital threats. Our expert team focuses on creating
              robust security measures that ensure the integrity and
              confidentiality of your data.
            </p>
            <p className=" text-gray-900/70 my-4 text-xl ">
              {/* {t("description")} */}
              Our approach is proactive; we recognize that each organization has
              unique security challenges. We utilize the latest technologies and
              best practices to develop solutions that safeguard your
      ...
      <section className="px-7 xl:px-36 pb-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {[
              {
                title: "Threat Assessment and Analysis",
                description:
            ...
            <AccordionContent className="flex flex-wrap p-3 justify-between mt-3 ">
              <div className="lg:w-[47%] mb-4">
                ...
                <p className="text-[16px] text-gray-900/80 py-3">
                  ...
                  networks, and programs from digital attacks, which aim to
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="flex flex-wrap p-3 justify-between mt-3 ">
              <div className="lg:w-[47%] mb-4">
                ...
                <p className="text-[16px] text-gray-900/80 py-3">
                  {/* {t("accordion.item1.description")} */}
                  With the increasing number of cyber threats, it is crucial to
                  protect your business data and systems from attacks that can
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent className="flex flex-wrap p-3 justify-between mt-3 ">
              <div className="lg:w-[47%] mb-4">
                ...
                <p className="text-[16px] text-gray-900/80 py-3">
                  {/* {t("accordion.item1.description")} */}
                  DH Solutions provides a range of cybersecurity services,
                  including threat assessment, incident response, and network
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent className="flex flex-wrap p-3 justify-between mt-3 ">
              <div className="lg:w-[47%] mb-4">
                ...
                <p className="text-[16px] text-gray-900/80 py-3">
                  {/* {t("accordion.item1.description")} */}
                  Common cyber threats include malware, phishing, ransomware,
                  and denial-of-service attacks, each targeting different
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent className="flex flex-wrap p-3 justify-between mt-3 ">
              <div className="lg:w-[47%] mb-4">
                ...
                <p className="text-[16px] text-gray-900/80 py-3">
                  {/* {t("accordion.item1.description")} */}
                  Regular updates are essential, as cyber threats are constantly
                  evolving. It is recommended to review and update your security
                  measures at least annually, or whenever a significant change
                  occurs within your organization.{" "}
                </p>
              </div>
            </AccordionContent>
          </AccordionItem>
